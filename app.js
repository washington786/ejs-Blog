...
app.post('/compose',function(req,res){
  ...
  // js object to hold blog post values
  let post = {title:'',description:''};
  post = {title:title,description:desc};
...
//   const postDesc = req.params.description;
//   res.render('post',{post_title:postTitle,post_description:postDesc});
// })
...
app.get('/posts/:title',function(req,res){
  ...
  posts.forEach(function(post){
    ...
    if(rtitle===postTitle || _.lowerCase(postTitle)===_.lowerCase(rtitle)){
      res.render('post',{post_title:postTitle,post_description:postDesc});
    }else{
